...
class OptionsMenu extends MusicBeatState
{
	...
	var options:Array<OptionCategory> = [
		new OptionCategory("Gameplay", [
			...
			new RushiaTrain("Toggle Rushia train sound."),
			#if desktop
		...
		new OptionCategory("Appearance", [
			...
			new SanityNotes("Change the appearance of certain sanity notes"),
		...
		new OptionCategory("Misc", [
			...
			new DefaultVolumeOption("Set Default Volume on startup."),
