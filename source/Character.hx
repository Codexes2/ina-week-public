...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'gf-sus':
				...
				tex = Paths.getSparrowAtlas('GF_sus','shared',true);
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
			...
			case 'spooky':
				...
				animation.addByPrefix('guraA', 'guraA 0', 24, false);
				animation.addByPrefix('ameHic', 'ameHic 0', 24, false);
			...
			case 'ina2':
				tex = Paths.getSparrowAtlas('characters/ina2', 'shared');
				frames = tex;
				animation.addByPrefix('idle', 'InaP2_Idle', 24);
				animation.addByPrefix('singUP', 'InaP2_Up', 24);
				animation.addByPrefix('singRIGHT', 'InaP2_Right', 24);
				animation.addByPrefix('singDOWN', 'InaP2_Down', 24);
				animation.addByPrefix('singLEFT', 'InaP2_Left', 24);
			...
			case 'inaKnight':
				...
				frames = tex;
				animation.addByPrefix('idle', 'InaKnight_Idle', 24);
				animation.addByPrefix('singUP', 'InaKnight_Up', 24);
				animation.addByPrefix('singRIGHT', 'InaKnight_Right', 24);
				animation.addByPrefix('singDOWN', 'InaKnight_Down', 24);
				animation.addByPrefix('singLEFT', 'InaKnight_Left', 24);
			...
			case 'inaKnightP2':
				tex = Paths.getSparrowAtlas('characters/inaKnightP2', 'shared');
				frames = tex;
			...
			case 'bf':
				...
				flipX = true;
			case 'bf-scared':
				var tex = Paths.getSparrowAtlas('bfScared','shared',true);
				frames = tex;
	...
	public function dance()
	{
		if (!debugMode)
		{
			switch (curCharacter)
			{
				case 'gf' | 'gf-sus' | 'gf-christmas' | 'gf-car' | 'gf-pixel':
