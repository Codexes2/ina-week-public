...
class Note extends FlxSprite
{
	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?inCharter:Bool = false, ?noteType = "normal")
	{
		super();
		...
		if (inCharter)
		{
			...
			if (noteType == 'sanity')
			{
				frames = Paths.getSparrowAtlas('notes/' + FlxG.save.data.sanityNotes + '/NOTE_sanity');
			...
			if (noteType == 'nightmare')
			{
				frames = Paths.getSparrowAtlas('notes/' + FlxG.save.data.sanityNotes + '/NOTE_nightmare');
	...
	override function update(elapsed:Float)
	{
		...
		if (mustPress)
		{
			...
			if (daStage == 'ES2' && noteType == 'nightmare' || daStage == 'stage' && noteType == 'nightmare')
			{
				//fine ill make nightmare notes harder to hit ig
