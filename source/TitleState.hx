...
class TitleState extends MusicBeatState
{
			...
			new FlxTimer().start(2, function(tmr:FlxTimer)
				{
					...
					FlxG.switchState(new SetLanguage());
	...
	override function beatHit()
	{
		...
		switch (curBeat)
		{
			...
			case 12:
				createCoolText(['Fanmade Week', 'for']);
			// credTextShit.visible = true;
			case 14:
				addMoreText("HoloFunk");
			case 16:
				deleteCoolText();
			case 18:
				curWacky = FlxG.random.getObject(getIntroTextShit());
			...
			case 22:
				deleteCoolText();
			case 24:
				createCoolText(['Holofunk', 'x']);
			// credTextShit.visible = true;
			case 26:
				addMoreText('Ina Week');
			// credTextShit.text += '\nlmao';
			case 28:
				deleteCoolText();
			case 30:
				addMoreText('The Drop');
				addMoreText('by ASARI lol');
