...
class SanityNotes extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.sanityNotes = !FlxG.save.data.sanityNotes;
	...
	private override function updateDisplay():String
	{
		return  "Sanity Notes " + (!FlxG.save.data.sanityNotes ? "Darker" : "Lighter");
	}
}
...
class RushiaTrain extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.rushia = !FlxG.save.data.rushia;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return "Rushia train " + (!FlxG.save.data.rushia ? "off" : "on");
	}
}
...
class DefaultVolumeOption extends Option
{
	...
	override function getValue():String {
		return "Current Default Volume: " + HelperFunctions.truncateFloat(FlxG.save.data.volume,1);
	}
...
class ResetSettings extends Option
{
	...
	public override function press():Bool
	{
		...
		FlxG.save.data.inaHard = null;
		FlxG.save.data.beatInapurgation = null;
		FlxG.save.data.beatEldritchPhantasm = null;
