...
class KadeEngineData
{
    public static function initSave()
    {
		...
		if (FlxG.save.data.rushia == null)
			FlxG.save.data.rushia = false;		
		...
		if (FlxG.save.data.sanityNotes == null)
		...
		if (FlxG.save.data.beatInapurgation == null)
			FlxG.save.data.beatInapurgation = false;

		if (FlxG.save.data.beatEldritchPhantasm == null)
			FlxG.save.data.beatEldritchPhantasm = false;
