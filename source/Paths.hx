...
class Paths
{
	...
	inline static public function voices(song:String)
	{
		var songLowercase = StringTools.replace(song, " ", "-").toLowerCase();
			...
			if (song.toLowerCase() == "cinderella" && Main.antiBonk){
				return 'songs:assets/songs/${song.toLowerCase()}/AntiBonk.$SOUND_EXT';
			}
			else{
	...
	inline static public function inst(song:String)
	{
		var songLowercase = StringTools.replace(song, " ", "-").toLowerCase();
			...
			if (song.toLowerCase() == "sharkventure" && Main.antiBonk){
				return 'songs:assets/songs/${song.toLowerCase()}/AntiBonk.$SOUND_EXT';
			}				
			else{
